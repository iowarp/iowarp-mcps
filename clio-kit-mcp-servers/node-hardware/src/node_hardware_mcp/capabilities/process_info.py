        ...
        for proc in psutil.process_iter(
            ...
            try:
                ...
                if process_info["memory_info"]:
                    ...
                    process_info["memory_vms_formatted"] = format_bytes(
                        process_info["memory_info"].vms
                    )

                process_info["cpu_percent_formatted"] = format_percentage(
                    process_info["cpu_percent"] or 0
                )
                process_info["memory_percent_formatted"] = format_percentage(
